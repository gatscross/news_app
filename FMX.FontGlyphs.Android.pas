...
//    NameFont := TPath.Combine(TPath.GetDocumentsPath, CurrentSettings.Family + '.ttf');
    ...
    if FileExists(NameFont) then
      TypeFace := TJTypeFace.JavaClass.createFromFile(StringToJString(NameFont))
    else
      Typeface := TJTypeface.JavaClass.create(FamilyName, TypefaceFlag);
